...
//     }
// }
// console.log(checkIfGameIsOver(numberOflives:6));
...
var hasPermit = false;
if (userAge < 15){
    alert("sorry your not eligible for a permit!")
} else {
    if(userage === 15){
...
var weatherMessage = ("raining");
switch (weatherMessage) {
    case "raining":
        alert("its raining");
        break;
    case "sunny":
    ...
    case "snow":
        ...
        break;
    default:
        alert(weatherMessage + "Its a great day");
        break;
