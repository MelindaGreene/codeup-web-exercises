...
var shapes= ["square", "rectangl", "circle", "triangle"];
// console.log(shapes);
...
//
// var favoriteFoods = ['Vinegar Chips', 'Pizza', 'Cheese'];
...
// console.log('The length of the shapes array is:' + instructors.length);
// TODO: console.log the length of the daysOfTheWeek array
// console.log('The length of the days of the week:' + daysOfTheWeek.length);
// TODO: console.log the length of the favoriteFoods array
// console.log('The length of the days of the week:' + favoriteFoods.length);
...
// for (var i = 0; i < instructors.length; i++) {
//     if [(instructors[i]) ==="vivian" || instructors[i] === "david" || instructors[i] === "sophie")];
//     alert("hey, i know" + instructors);
// }else{
//     alert("I havent had calss witj" + instructors[i] + "yet");
//
//     }
// }
